...
class RecentUpdateListWidget extends StatelessWidget {
            ...
            Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                    receiverName != null ? receiverName : "Amisha",
                    style: TextStyle(
                        color: Colors.black87,
                        fontSize: 18.0,
                        fontWeight: FontWeight.bold),
  ...
  String getSecondlineDesc() {
    String age = receiverAge != null ? receiverAge : '20';
    String sex = receiverSex != null ? receiverSex : 'Female';
    String distance = receiverDistance != null ? receiverDistance : '5KM';

    return '$age   $sex   $distance ';
  }
}
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    alignment: Alignment.center,
                    color: Colors.black87,
                    child: Text(bloodGroup != null ? bloodGroup : "O+ve",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 20.0,
                            fontWeight: FontWeight.bold)),
