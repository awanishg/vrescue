      ...
      child: Stack(children: [
        Scaffold(
          ...
          body: Column(
            children: <Widget>[
              Row(),
              _buildDonateCard("Donate to 57357", "80,000", "29/1/2020"),
              _buildDonateCard("Donate to Civil Hospital", "90,000", "13/1/2020"),
              _buildDonateCard("Donate to NGO", "30,000", "01/02/2020")
            ],
          ),
        ),
        SafeArea(
